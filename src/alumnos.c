...
/**
 * @brief Estructura constante con los datos de Esteban Volentini
 */
...
/**
 * @brief Estructura constante con los datos de Emiliano Rodriguez
 */
static const struct alumno_s EMILIANO_RODRIGUEZ = {
    .apellidos = "RODRIGUEZ",
